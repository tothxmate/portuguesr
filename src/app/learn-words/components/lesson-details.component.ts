...
export class LessonDetailsComponent implements OnInit{    
  ...
  constructor(private router: Router, private fb: FormBuilder, learnWordsService: LearnWordsService) {
    ...
    this.learnWordsService.getLessonNameByKey(this.lessonKey).subscribe((data: string)=>{
      console.warn(data)
    })
  }
